...
export const createUser = async (req, res) => {
  ...
  if (password !== confirmPassword) { // jika password tidak sama dengan confirmPassword
...
export const updateUser = async (req, res) => {
  ...
  if (password === "" || password === null) { // jika password kosong atau null
  ...
  try {
    await Users.update( // update data user
      {
        name: name, // dengan data name
        email: email, // email
        password: hashPassword, // password yang sudah di hash
